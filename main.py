...
while running:
    ...
    mode_text = "Режим: СВЯЗАННЫЕ линии (правая кнопка мыши - переключить режимы)" if draw_connected else "Режим: ОТДЕЛЬНЫЕ линии (правая кнопка мыши - переключить режимы)"
